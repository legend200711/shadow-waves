/* ══════════════════════════════════════════════════════════════
   Shadow Nexus Wave — Profile Music System
...
(function () {
  ...
  async function uploadToR2(r2Key, file, uid, onProgress) {
    ...
    // Attach Firebase ID token so the Worker can verify the caller owns the uid.
    try {
    ...
    } catch (_idTokErr) { /* best-effort — worker will reject if missing */ }
