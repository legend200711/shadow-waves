...
// e.g. / on shadowfirelive.com or localhost
...
messaging.onBackgroundMessage((payload) => {
  ...
  const title   = notif.title || TYPE_TITLES[type] || '🔔 Shadow Nexus Wave';
...
self.addEventListener('push', (event) => {
  ...
  const title = (parsed && parsed.notification && parsed.notification.title) || '🔔 Shadow Nexus Wave';
